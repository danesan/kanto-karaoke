  ...
  return (
    <section className="rounded-lg border bg-white shadow-sm">
      ...
      <div className="divide-y">
        {items.map((item) => {
          const canRemove = item.addedByParticipantId === participantId && item.status === "WAITING";

          return (
            <div key={item.id} className="grid grid-cols-[36px_1fr_auto] items-center gap-3 p-3">
